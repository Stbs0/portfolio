    ...
    <section id='experience'>
      ...
      <div className=' container mx-auto 2xl '>
        <div className='md:flex md:flex-row md:justify-between pt-5'>
          <div className='flex items-center gap-3'>
            <Image
              ...
              height={30}
              width={30}
              alt={"Mohammed Mahmoud - UX Experience"}
            />
            <p className='dark:text-gray-300 '>
              <span className='font-semibold'>WebHR /</span> Software Engineer
            </p>
          </div>
          <p className='dark:text-gray-300 md:pt-0 pt-3'>
            May 2022 - Present, United States
          </p>
        </div>

        <p className='dark:text-gray-300 pt-5'>
        ...
        <div className='flex-col flex sm:flex-row '>
          <div className='bg-transparent  mt-5 mr-2 cursor-pointer  rounded-3xl  dark:text-white py-2 px-5  border dark:border-[#2E2E2E] w-max'>
            React Native
          </div>
          <div className='bg-transparent  mt-5  mr-2 cursor-pointer  rounded-3xl  dark:text-white py-2 px-5  border dark:border-[#2E2E2E] w-max'>
            React
          </div>
          <div className='bg-transparent  mt-5  mr-2 cursor-pointer  rounded-3xl  text-white py-2 px-5  border dark:border-[#2E2E2E] w-max'>
            JavaScript
          </div>
          <div className='bg-transparent  mt-5 cursor-pointer  rounded-3xl  text-white py-2 px-5  border dark:border-[#2E2E2E] w-max'>
            Typescript
          </div>
        </div>
      </div>
